...
auto invoke(T B::* pmf, D&& ref, A&&... args) noexcept(noexcept((std::forward<D>(ref).*pmf)(std::forward<A>(args)...)))
    -> std::enable_if_t<std::is_function<T>::value && std::is_base_of<B, std::decay_t<D>>::value,
        decltype((std::forward<D>(ref).*pmf)(std::forward<A>(args)...))> {
  return (std::forward<D>(ref).*pmf)(std::forward<A>(args)...);
}

template <typename B, typename T, typename RefWrap, typename... A>
auto invoke(T B::* pmf, RefWrap&& ref, A&&... args) noexcept(noexcept((ref.get().*pmf)(std::forward<A>(args)...)))
...
auto invoke(T B::* pmf, P&& ptr, A&&... args) noexcept(
    ...
    -> std::enable_if_t<std::is_function<T>::value && !is_reference_wrapper<std::decay_t<P>>::value &&
        ...
        decltype(((*std::forward<P>(ptr)).*pmf)(std::forward<A>(args)...))> {
...
auto invoke(F&& f, A&&... args) noexcept(noexcept(std::forward<F>(f)(std::forward<A>(args)...)))
