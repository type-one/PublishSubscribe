...
/**
 * Attaches interruptible continuation function `f` to this shared_future
 * object. [EXTENSION]
 *
 * Function must be callable with signature `void(promise<R>,
 * shared_future<T>)`. Promise object passed as the first parameter can be used
